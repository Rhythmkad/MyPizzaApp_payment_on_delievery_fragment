...
import com.rhythm.mypizzaapp.fragments.OrderPaymentFragment;
...
public class CommonActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void checkIntent() {
        if (getIntent() != null && getIntent().getStringExtra(GlobalConstants.FRAGMENT_INTENT_DATA.FRAGMENT_TAG) != null && !getIntent().getStringExtra(GlobalConstants.FRAGMENT_INTENT_DATA.FRAGMENT_TAG).isEmpty()) {
            ...
            // here we are getting the complete order list of pizza selected by the user from PlaceOrderFragment as a Bundle
            // and parsing this bundle into ArrayList of type OrderHistoryBeanClass and sending this list
            // as a perimeter to MyCartFragment.
            ...
            if (mValidationsClass.checkStringNull(title)) {
                ...
                callFragments(fragmentTag, title, 0, false, null, "");
            }
        }
    }

    // calling fragments
    public void callFragments(String fragTag, String fragName, int removeFragCount, boolean removeFragCheck, ArrayList<OrderHistoryBeanClass> completeOrderList, String subTotalAmount) {
        ...
        switch (fragTag) {
            ...
            case GlobalConstants.FRAGMENT.CONFIRM_ORDER_FRAGMENT:
                mFragment = new OrderPaymentFragment(completeOrderList, subTotalAmount);
                break;
        }
        if (mFragment != null) {
